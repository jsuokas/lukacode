...
var LUKACODE_API_URL = process.env.LUKACODE_API_URL;
var LUKACODE_API_KEY = process.env.LUKACODE_API_KEY;
...
function Home(_ref) {
  ...
  }, "lukacode.dev")), pages.pages.map(function (it, idx) {
    return __jsx("div", {
      key: idx,
      className: "jsx-2291428837",
      __self: _this,
...
Home.getInitialProps = function _callee() {
  var graphQLClient, query, pages;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          graphQLClient = new graphql_request__WEBPACK_IMPORTED_MODULE_3__["GraphQLClient"](LUKACODE_API_URL, {
            headers: {
              authorization: "Bearer ".concat(LUKACODE_API_KEY)
            }
          });
          query = "\n  { \n    pages {\n      id\n      name\n      description\n    }\n  }\n";
          _context.next = 4;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(graphQLClient.request(query));
